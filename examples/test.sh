...
../ngsLD --n_threads 10 --verbose 1 --n_ind $N_IND --n_sites $N_SITES --geno testLD_T.geno.gz --pos testLD.pos --max_dist 20 --rnd_sample 0.5 --seed 12345 | sort -k 1,1V -k 2,2V > testLD_Tr.ld
